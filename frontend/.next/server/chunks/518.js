...
function MainCarousel({ type, imgUrls, data }) {
    ...
    const GameCarouselSlides = type === "main" && data === undefined || type === "info" && imgUrls === undefined ? /*#__PURE__*/ jsx_runtime.jsx(carousel_.Carousel.Slide, {
        children: /*#__PURE__*/ jsx_runtime.jsx(core_.Image, {
            src: "/images/nonImageRectangle.svg",
            fit: "fill"
        })
    }) : type === "main" ? (data?.map((value)=>{
        return value.data.data.map((data)=>/*#__PURE__*/ jsx_runtime.jsx(carousel_.Carousel.Slide, {
                children: /*#__PURE__*/ jsx_runtime.jsx(core_.BackgroundImage, {
    ...
    })) : (imgUrls?.map((url)=>/*#__PURE__*/ jsx_runtime.jsx(carousel_.Carousel.Slide, {
            children: /*#__PURE__*/ jsx_runtime.jsx(core_.Container, {
